...
public class UnsafeInstantiator implements Instantiator {
	...
	private static final Logger log = Logger.getLogger(UnsafeInstantiator.class.getName());

	private void init() {
		log.info("init: UnsafeInstantiator isn't available");
    }
    ...
    public <T> T instantiate(Class<T> clazz) {
        throw new WeldException(UNSAFE_INSTANTIATION_FAILED, clazz);
    }
}